...
import server.Daos.EmployeeDao;
import server.Daos.JdbcUserDao;
...
public class EmployeeController {
     ...
     */
    public EmployeeController(EmployeeDao employeeDao, JdbcUserDao userDao) {
    ...
    @GetMapping("")
    public List<Employee> listEmployees(Principal principal) {
